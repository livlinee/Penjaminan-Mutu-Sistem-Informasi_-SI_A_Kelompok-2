        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white p-8 rounded-lg shadow-lg">
                ...
                <div class="flex justify-between items-center mb-6">
                    <h2 class="text-2xl font-bold text-gray-800">Edit Mentor: {{ $mentor->nama_mentor }}</h2>
                ...
                <form action="{{ route('admin.mentor.update', $mentor->id_mentor) }}" method="POST"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            {{-- UBAH: Isi value dengan data lama --}}
                        ...
                        <div>
                            ...
                            <input type="text" name="materi" id="materi"
                                value="{{ old('materi', $mentor->materi) }}"
                                class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                                required>
                        </div>
                        <div>
                            ...
                            <input type="text" name="jadwal_dan_waktu" id="jadwal_dan_waktu"
                                value="{{ old('jadwal_dan_waktu', $mentor->jadwal_dan_waktu) }}"
                        ...
                        <div>
                            ...
                            <input type="text" name="kontak" id="kontak"
                                value="{{ old('kontak', $mentor->kontak) }}" placeholder="Contoh: 08123..."
                                class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                                required>
                        </div>
                    </div>
                    ...
                    <div>
                        <label for="gambar" class="block text-sm font-medium text-gray-700">Upload foto baru
                            (Opsional)</label>
                        {{-- Tampilkan gambar saat ini --}}
                        <img src="{{ asset('images/mentors/' . $mentor->gambar) }}" alt="Gambar saat ini"
                            class="w-24 h-24 object-cover rounded-md my-2">
